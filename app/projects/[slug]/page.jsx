  ...
  return (
    <section className=''>
        <div className='md:max-w-4xl px-4 sm:px-8 md:px-0 mx-auto py-12 sm:py-14'>
          <h2 className='font-rale text-[2.25rem] xs:text-[50px] capitalize font-[500] pb-5'>About the project</h2>
          <div className='flex flex-col gap-4'>
          <p className='font-rale text-[18px] '>{project.about1}</p>
          <p className='font-rale text-[18px] '>{project.about2}</p>
           <div className='flex flex-col justify-center items-center xs:flex-row gap-6'>
