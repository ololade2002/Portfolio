...
const Project = () => {
  return (
    ...
    <h1 className='text-left  text-[40px] font-medium '>Projects</h1>
    ...
    <Image className='h-[30vh] sm:h-[85vh] hover:scale-105 transition duration-[0.9s] rounded-lg object-cover' src={entire} alt='Entire-studios'/>
    <div>  
    </div>
    </div>
    ...
    <Image className='rounded-lg  h-[30vh] img-box sm:h-[65vh] hover:scale-105 transition duration-[0.9s] object-cover lg:h-[40vh]' src={img1} alt='Entire-studios'/>   
    </div>   
    <div className='w-full sm:w-6/12  lg:w-full text-white'>
    ...
    <Image className=' h-[30vh] sm:h-[85vh] hover:scale-105 transition duration-[0.9s] rounded-lg object-cover ' src={cowboy1} alt='Home Rental Website'/>
    <div>  
    </div>
    </div>
    <div className='w-full lg:w-6/12 flex flex-col sm:flex-row gap-4 lg:gap-0 lg:flex-col '>
    <div className='w-full rounded-lg relative overflow-hidden  sm:w-6/12 lg:w-full'>
    <Image className='rounded-lg hover:scale-105 transition duration-[0.9s]  h-[30vh] sm:h-[65vh] object-cover lg:h-[40vh]' src={cowboy2} alt='Home Rental Website'/>    
    </div>
    <div className=' w-full sm:w-6/12 lg:w-full text-white'>
    ...
    <div className='w-full lg:w-6/12 flex flex-col sm:flex-row gap-4 lg:gap-0 lg:flex-col'>
    <div className='w-full rounded-lg relative overflow-hidden sm:w-6/12 lg:w-full'>
    <Image className='rounded-lg h-[30vh] sm:h-[65vh] hover:scale-105 transition duration-[0.9s] object-cover lg:h-[40vh]' src={img3} alt='Entire-studios'/>    
    </div>
    ...
    <div className='w-full lg:w-6/12 flex flex-col sm:flex-row gap-4 lg:gap-0 lg:flex-col '>
    <div className='w-full rounded-lg relative overflow-hidden sm:w-6/12 lg:w-full'>
    <Image className='rounded-lg hover:scale-105 transition duration-[0.9s] h-[30vh] sm:h-[65vh] object-cover lg:h-[40vh]' src={img4} alt='Home Rental Website'/>    
    </div>
    <div className=' w-full sm:w-6/12 lg:w-full text-white'>
    ...
    <div className='w-full rounded-lg relative overflow-hidden lg:w-8/12 '>
    <Image className='h-[30vh] sm:h-[85vh] hover:scale-105 transition duration-[0.9s] rounded-lg object-cover' src={img6} alt='Photography Landing Page'/>
    <div>  
    </div>
    </div>
    ...
    <div className='w-full lg:w-6/12 flex flex-col sm:flex-row gap-4 lg:gap-0 lg:flex-col'>
     <div className='w-full rounded-lg relative overflow-hidden sm:w-6/12 lg:w-full'>
    <Image className='rounded-lg hover:scale-105 transition duration-[0.9s] img-box h-[30vh] sm:h-[65vh] object-cover lg:h-[40vh]' src={img7} alt='Photography Landing Page'/>    
     </div>
    <div className='w-full sm:w-6/12 lg:w-full text-white'>
    ...
    <div className='w-full lg:w-6/12 flex flex-col sm:flex-row gap-4 lg:gap-0 lg:flex-col '>
    <div className='w-full rounded-lg relative overflow-hidden sm:w-6/12 lg:w-full'>
    <Image className='rounded-lg hover:scale-105 transition duration-[0.9s] h-[30vh] sm:h-[65vh] object-cover lg:h-[40vh]' src={img9} alt='Modern Payment Website'/>    
    </div>
    <div className='w-full sm:w-6/12 lg:w-full text-white'>
    ...
    <div className='w-full rounded-lg relative overflow-hidden lg:w-8/12 '>
    <Image className='h-[30vh] sm:h-[85vh] hover:scale-105 transition duration-[0.9s] shadow-2xl rounded-lg object-cover' src={img10} alt='Entire-studios'/>
    <div>  
    </div>
    </div>
